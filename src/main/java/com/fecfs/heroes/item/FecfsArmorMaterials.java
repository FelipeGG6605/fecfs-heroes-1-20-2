...
public enum FecfsArmorMaterials implements ArmorMaterial {
    TB_2022("tb_2022", 50, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
    ...
    }), 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 12.0f, 0.2f, () -> Ingredient.ofItems(null));
    ...
    private FecfsArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredientSupplier) {
        this.name = name;
    ...
    public String getName() {
        return FecfsHeroes.MOD_ID + ":" + this.name;
    }
